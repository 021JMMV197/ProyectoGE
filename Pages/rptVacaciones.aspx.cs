...
namespace ProyectoGE.Pages
{
    public partial class rptVacaciones : System.Web.UI.Page
    {
        ...
        protected async void btnPdf_Click(object sender, EventArgs e)
        {
            ...
            {
                lblMsg.Text = "Error al exportar (iText): " + pex.Message +
                              (pex.InnerException != null ? " | Inner: " + pex.InnerException.Message : "");
            }
            catch (Exception ex)
            {
        ...
        private static DateTime? ParseFecha(string s)
        {
            ...
            if (DateTime.TryParseExact(s.Trim(), "yyyy-MM-dd", System.Globalization.CultureInfo.InvariantCulture,
        ...
        // ===== PDF con fuentes estándar (sin TTF, sin BouncyCastle) =====
            ...
            string estadoFiltro)
        {
            using (var ms = new System.IO.MemoryStream())
            {
                ...
                // Fuentes estándar (NO TTF, NO IDENTITY_H)
